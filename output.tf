...
# arn:aws:secretsmanager:us-west-2:384990607798:secret:appsync-tutorial-mysql-secret-02e8v12hxq0o-0Jn9ce

# output "mysql_write_endpoint" {
#   value = module.aurora_mysql.cluster_endpoint
# }

# output "mysql_read_endpoint" {
